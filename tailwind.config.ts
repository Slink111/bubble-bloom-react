	...
	theme: {
		...
		extend: {
			colors: {
				...
				'game-cyan-dark': 'hsl(var(--game-cyan-dark))',
				'game-magenta': 'hsl(var(--game-magenta))',
				'game-magenta-dark': 'hsl(var(--game-magenta-dark))',
				'game-lime': 'hsl(var(--game-lime))',
				'game-lime-dark': 'hsl(var(--game-lime-dark))',
				'game-orange': 'hsl(var(--game-orange))',
				'game-orange-dark': 'hsl(var(--game-orange-dark))',
				'game-dark-purple': 'hsl(var(--game-dark-purple))',
				'game-ultra-dark': 'hsl(var(--game-ultra-dark))',
